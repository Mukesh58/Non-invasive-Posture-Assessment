...
def main():
        ...
        frameInterval = 8 # (1 out of n): Frequency of frames that will be captured and used for processing
        calib_framesRequired = 15 # Number of frames in confidence threshold to achieve satisfactory calibration
        break_interval = 45 # Number of minutes until a periodic break reminder is issued
        ...
        while True:
                ...
                if frameNum % frameInterval == 0  and frameNum > 1 * fps:
                    ...
                    if boolUserInFrame == True and calibFlag == False:
                        ...
                        print(str(diff_nose_x / calib_nose[0]) + "    " + str(diff_eyeL_x/calib_eyeL[0]) + "    " + str(diff_eyeR_x/calib_eyeR[0]) + "    " + str(dist_noseNeck_x))
                        ...
                        # if diff_nose_y > 30.8454 and diff_eyeL_y > 22.1793 and diff_eyeR_y > 22.1793 and diff_neck_y > 15.0192 and diff_shoulderL_y > 18 and diff_shoulderR_y > 18 and (dist_shoulderBreadth/calib_shoulderBreadth) > 1.08 and (dist_noseNeck_y/calib_noseNeck_y) >0.83:
                        ...
                        # elif diff_nose_y > 34 and diff_eyeL_y > 25 and diff_eyeR_y > 25 or (dist_eyes_x/calib_eyes_x) > 1.1 and (dist_noseNeck_y/calib_noseNeck_y) <0.83:
                            print("Forward Head")
                            currentPosture = 2
                        elif (diff_eyeL_y / calib_eyeL[1]) > 0.06 and (diff_eyeR_y / calib_eyeR[1]) < -0.02 and offset_eyesLR_y > 12:
                            # elif diff_eyeL_y > 8.5414 and diff_eyeR_y < 6 and offset_eyesLR_y > 13.5396:
                            print("Head Tilted - Left")
                            currentPosture = 3
                        elif (diff_eyeL_y/calib_eyeL[1]) < -0.02 and (diff_eyeR_y/calib_eyeR[1]) > 0.06 and offset_eyesLR_y < -12:
