...
def main():
        ...
        print("[Frame_Number, [Nose, Neck], [[Eye_L], [Eye_R]], [[Shoulder_L], [Shoulder_R]]")
        ...
        while True:
                ...
                if frameNum % 5 == 0:
                    ...
                    # try:
                    #     eyes = [[[datum.poseKeypoints[0][16][0]], [datum.poseKeypoints[0][16][1]], [datum.poseKeypoints[0][16][2]]],
                    ...
                    try:
                        eye_L = [datum.poseKeypoints[0][16][0], datum.poseKeypoints[0][16][1], datum.poseKeypoints[0][16][2]]
                    except:
                        eye_L = [[-1], [-1], [-1]]


                    try:
                        eye_R = [datum.poseKeypoints[0][15][0], datum.poseKeypoints[0][15][1], datum.poseKeypoints[0][15][2]]
                    except:
                        eye_R = [[-1], [-1], [-1]]
                    ...
                    frameData = [[frameNum,0,0], neckLine[0], neckLine[1], eye_L, eye_R, shoulder[0], shoulder[1]]
                    print(frameData)

                    # Data Structure: [Frame_Number, [Nose, Neck], [[Eye_L], [Eye_R]], [[Shoulder_L], [Shoulder_R]]
                    ...
                    if key==ord('q') or frameNum == 50: ######################################## COUNTER SET TO 25 FRAMES
                        break
