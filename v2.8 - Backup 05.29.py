...
def main():
        ...
        break_interval = 5 # Set break interval in minutes
        ...
        while True:
                ...
                if frameNum % 3 == 0  and frameNum > 0 * fps:
                    ...
                    if boolUserInFrame == True and calibFlag == False:
                        ...
                        if diff_nose_y > 35.30942 and diff_eyeL_y > 25 and diff_eyeR_y > 25 or (dist_eyes_x/calib_eyes_x) > 1.2:
                            print("Forward Head")
                        ...
                        if count_unhealthyPose > 30:
                            ...
                            print("Unhealthy pose detected")
                            count_poseEvent += 1
                            count_unhealthyPose = 0
                            print("Count of pose events: " + str(count_poseEvent))
                            print("--------------------Image Saving-----------------")
                            img_name = check_fileName("img/" + start_time + "_UnhealthyPoseDetected.png")
                            cv2.imwrite(img_name, img)
